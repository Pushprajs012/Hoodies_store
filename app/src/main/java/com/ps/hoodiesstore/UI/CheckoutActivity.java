...
import com.ps.hoodiesstore.Data.User;
import com.ps.hoodiesstore.R;
import com.ps.hoodiesstore.databinding.ActivityCheckoutBinding;
...
public class CheckoutActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.paymentGroup.setOnCheckedChangeListener((group, checkedId) -> {
            ...
            if (checkedId == R.id.payment_option_card) {
                binding.creditCardDetails.setVisibility(View.VISIBLE);
                cod=false;
            } else if (checkedId == R.id.payment_option_cod) {
                cod=true;
            }
        });
    }
    ...
    private void init(){
        ...
        binding.confirmOrderBtn.setOnClickListener(this);
    }
        ...
        db.getReference("Users").child(userId).child("User").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    binding.price.setText(String.valueOf(getIntent().getIntExtra("totalPrice",0)));
                }
            }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.confirm_order_btn){
